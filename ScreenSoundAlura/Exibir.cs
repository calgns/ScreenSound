    ...
    public static void OpcoesDoMenu() {
      ...
      Inicio:
        ...
        switch (opcaoEscolhida) {
            case 1: Banda.Registrar();        Intervalo.MeioTempo(); goto Inicio; break;
            case 2:       Bandas();           Intervalo.MeioTempo(); goto Inicio; break;
            case 3: Banda.Avaliar();          Intervalo.MeioTempo(); goto Inicio; break;
            case 4:       ExibirAvaliacoes(); Intervalo.MeioTempo(); goto Inicio; break;
            case 5: Banda.AtualizarRegistro();                       goto Inicio; break;
